...
# Install Rust (required for Pydantic v2)
echo "🦀 Checking for Rust/Cargo..."
if ! command -v cargo &> /dev/null; then
    echo "   Rust not found, installing..."
    echo "   This is required to compile Pydantic v2 (for Python 3.13+ support)"
...
# Make sure cargo is available in this shell
...
# Install Python dependencies (Pydantic v2 will compile with Rust)
echo "📦 Installing Python dependencies..."
echo "   Note: Pydantic v2 compilation may take a few minutes..."
